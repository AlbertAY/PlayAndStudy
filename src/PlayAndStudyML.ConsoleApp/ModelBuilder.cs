...
using PlayAndStudyML.Model;

namespace PlayAndStudyML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"F:\github\PlayAndStudy\src\MyMLApp\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../PlayAndStudyML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.LightGbm(labelColumnName: "Sentiment", featureColumnName: "Features");
