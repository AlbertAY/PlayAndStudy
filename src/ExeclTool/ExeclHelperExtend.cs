...
//    /// execl帮助扩展
//    /// </summary>
//    public static class ExeclHelperExtensions
//    {
//        /// <summary>
//        /// 金额可编辑区域
//        /// </summary>
...
//            //表头样式
//            execlCellStyleEntity.TitleStyle = ExeclHelperExtensions.EditTitleStyle(excelWorkbook);
//            //该字段为编辑字段，设置为编辑样式
//            execlCellStyleEntity.CellStyle = ExeclHelperExtensions.EditStyle(excelWorkbook);
//            //金额右对齐
...
//            //获取单元格样式
//            ICellStyle cellStyle = ExeclHelperExtensions.EditStyle(workBookStyle.BaseExcelWorkbook);
...
//        /// <param name="sheet"></param>
//        /// <param name="execlWorkBookStyle"></param>
//        public static void SheetAddValidationArea(ISheet sheet, WorkBookStyle execlWorkBookStyle)
//        {
//            //列限制区域
//            IEnumerable<ExcelColumnStyle> setValueCellList = execlWorkBookStyle.ExeclColumnStyleList.Where(it => it.DVConstraint != null);
//            string[] columnNames = execlWorkBookStyle.ColumnsName.Select(it => it.Key).ToArray();
//            foreach (ExcelColumnStyle item in setValueCellList)
//            {
//                for (int i = 0; i < columnNames.Length; i++)
//                {
//                    if (item.ColumnsName.Equals(columnNames[i]))
//                    {
//                        SetCellInputValidate(sheet, item, i, i);
//                        continue;
//                    }
//                }
//            }
